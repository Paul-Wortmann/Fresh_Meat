...
- While only the Linux build is currently being worked on, it should be trivial to get it to compile and run on Windows as most of the code and dependencies are cross platform. There are no plans to ever support Apple.
...
Many resources come from this amazing site: [OpenGameArt](https://opengameart.org)
...
It is recommended you either overwrite your older savegames with new ones, or delete the older ones when upgrading to a newer version.
...
Copyright (C) 2011-2026 Paul Wortmann.
